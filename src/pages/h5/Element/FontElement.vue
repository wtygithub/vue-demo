<template>
  <aside class='element' @mousedown="mousedown">
    <Operate class="operate" v-show="element === editingElement && element.isShowElement" :element="element" :style="styleBasic"/>
    <section class="content">
      <div v-show="element.isShowElement" :class="element['playing'] && 'animated ' + this.element['animatedName']" :style="styleAnime">
