...
export default class Element {
  constructor (ele = {}) {
    ...
    this.fontStyle = ele.fontStyle || 'normal'
    this.textDecoration = ele.textDecoration || 'none'
    this.color = ele.color || '#000000'
    this.zindex = ele.zindex || 1
    this.fill = ele.fill || '#229399'
    this.isShowElement = ele.isShowElement || true
    this.isUseLink = ele.isUseLink || false
    this.jumpUrl = ele.jumpUrl || ''
  }
}
