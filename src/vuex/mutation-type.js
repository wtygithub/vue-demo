...
export const SET_COPY_EDITOR_PAGE = 'SET_COPY_EDITOR_PAGE' // 设置复制后的编辑的页面
...
export const ADD_BG_ELEMENT = 'ADD_BG_ELEMENT' // 设置背景图
export const PUSH_PIC_LIST = 'PUSH_PIC_LIST' // 图片列表
export const PUSH_BG_PIC_LIST = 'PUSH_BG_PIC_LIST' // 图片列表
...
export const CHANGE_OPERATING_TYPE = 'CHANGE_OPERATING_TYPE'//更换操作类型--文本/图片/背景
export const SET_CANVAS_HEIGHT = 'SET_CANVAS_HEIGHT'//更改页面高度
export const SET_CANVAS_TYPE = 'SET_CANVAS_TYPE'//更改页面类型
export const SET_BG_MUSIC = 'SET_BG_MUSIC'//更改背景音乐
export const APPLY_BG_TO_OTHERS = 'APPLY_BG_TO_OTHERS'//更改背景音乐
export const CHANGE_AUDIO_PLAYING_STATE = 'CHANGE_AUDIO_PLAYING_STATE'//更改背景音乐播放状态
export const SET_THEME_ID = 'SET_THEME_ID'//模板Id
export const SET_COVER_IMG = 'SET_COVER_IMG'//保存封面
